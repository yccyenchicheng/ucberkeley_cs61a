...
def same_hailstone(a, b):
    ...
    return b in seq_hailstone(a) or a in seq_hailstone(b)
...
def part(n):
    ...
    627
    """
    def count_with(total, part):
        if total == 0:
            return 1
        elif part <= 0 or total < 0:
            return 0
        else:
            with_part = count_with(total - part, part)
            without_part = count_with(total, part - 1)

            return with_part + without_part

    return count_with(n, n)
