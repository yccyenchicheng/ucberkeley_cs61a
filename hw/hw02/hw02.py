...
def accumulate(combiner, base, n, term):
    ...
    if n == 0:
        ...
        ''' base + sequence's start '''
        sequence_result = combiner(base, term(1))
        ''' remaining '''
        for i in range(2, n + 1): 
            sequence_result = combiner(sequence_result, term(i))
...
def repeated(f, n):
    ...
    # How to use lambda in this question?
        g = f
        for i in range(n - 1):
            f = compose1(g, f)
